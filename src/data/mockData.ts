...
export const stages: Stage[] = [
  {
    ...
    timeframe: '',
    description: 'Get connected, get housed, secure your identity.',
    color: '#C62828',
  ...
  },
  {
    ...
    icon: 'heart-outline',
    timeframe: '',
    description: 'Build the financial and healthcare systems that run your life.',
    color: '#1565C0',
  ...
  },
  {
    ...
    timeframe: '',
    description: 'Build credit, file taxes, grow your safety net.',
    color: '#2E7D32',
  ...
  },
  {
    ...
    icon: 'home-outline',
    timeframe: '',
    description: 'Long-term financial and community roots. Homeownership and beyond.',
    color: '#E65100',
...
// ─── MONTHLY AMERICAN FACTS ───────────────────────────────────────────────────
export const monthlyAmericanFacts: Record<number, { title: string; body: string; icon: string }> = {
  0: {
    title: 'Martin Luther King Jr. Day',
    body: 'Every third Monday in January, the US honors Dr. King — the only private citizen with a federal holiday. It\'s also a day of national service: many Americans volunteer in their communities instead of taking the day off.',
    icon: 'ribbon-outline',
  },
  1: {
    title: 'Black History Month',
    body: 'February is Black History Month, a tradition that began in 1926 as a single week. The US is one of a handful of countries that officially observes it for a full month. On February 2, Americans also watch a groundhog named Punxsutawney Phil to "predict" if winter will last six more weeks — yes, this is taken somewhat seriously.',
    icon: 'star-outline',
  },
  2: {
    title: 'St. Patrick\'s Day & Irish Immigration',
    body: 'On March 17, Americans wear green — even those with no Irish ancestry. The Irish were one of the largest immigrant groups in the 1800s and shaped cities like Boston, New York, and Chicago. Chicago dyes its river green every year to celebrate.',
    icon: 'color-palette-outline',
  },
  3: {
    title: 'Tax Day: April 15',
    body: 'April 15 is one of the most universally known dates in America — the federal income tax deadline. The income tax was established by the 16th Amendment in 1913. If April 15 falls on a weekend or holiday, the deadline shifts to the next business day.',
    icon: 'document-text-outline',
  },
  4: {
    title: 'Asian American & Pacific Islander Heritage Month',
    body: 'May honors AAPI communities whose contributions shaped the US — including Chinese workers who built the transcontinental railroad completed in 1869. Today, 24 million AAPI people live in the US. Memorial Day falls on the last Monday of May: federal offices, banks, and the DMV are closed.',
    icon: 'globe-outline',
  },
  5: {
    title: 'Juneteenth — June 19',
    body: 'Juneteenth became a federal holiday in 2021, but Americans have celebrated it since 1865 — the day enslaved people in Texas learned they were free, two years after the Emancipation Proclamation. It\'s one of the newest federal holidays and marks a major turning point in American history.',
    icon: 'sunny-outline',
  },
  6: {
    title: 'Independence Day — July 4',
    body: 'On July 4, 1776, the Declaration of Independence was adopted, separating the 13 colonies from Britain. Today, Americans celebrate with fireworks, barbecues, and parades — fireworks alone are a $2 billion industry. Federal offices, banks, and most businesses close for the day.',
    icon: 'sparkles-outline',
  },
  7: {
    title: 'Back-to-School Season',
    body: 'August marks the start of the US school year — a concept unfamiliar in countries where school begins in spring or fall. Retailers run major sales on supplies. If you have children, school registration deadlines and immunization requirements vary by state and are usually due before August.',
    icon: 'school-outline',
  },
  8: {
    title: 'Labor Day — First Monday in September',
    body: 'Labor Day honors the American labor movement and the fight for the 8-hour workday. It\'s always the first Monday in September — a long weekend that Americans call the "unofficial end of summer." After Labor Day, wearing white is traditionally considered a fashion faux pas (though this rule is fading).',
    icon: 'briefcase-outline',
  },
  9: {
    title: 'Two Names, One Date',
    body: 'The second Monday of October is officially Columbus Day federally, but many states and cities now call it Indigenous Peoples\' Day to recognize Native American history. You may see both names depending on where you live. Federal offices close; banks and the DMV may or may not.',
    icon: 'map-outline',
  },
  10: {
    title: 'Thanksgiving — Always the 4th Thursday',
    body: 'Thanksgiving is always the fourth Thursday in November — never the same date. It traces to a 1621 harvest feast between the Pilgrims and the Wampanoag people. The day after — "Black Friday" — is historically the biggest retail shopping day of the year, with deals starting at midnight or earlier.',
    icon: 'restaurant-outline',
  },
  11: {
    title: 'A Month of Three Holidays',
    body: 'December is unique: Christmas (Dec 25), Hanukkah (date varies, 8 nights), and Kwanzaa (Dec 26–Jan 1) all overlap. Unlike many countries, the US does not have an official state religion, so "Happy Holidays" is the inclusive greeting many use to acknowledge all three. December 24 and 25 are federal holidays.',
    icon: 'gift-outline',
  },
};
